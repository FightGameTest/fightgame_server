class ObjectMaker {
    ...
    public allocate(Type: any, arr: any[]): any {
        let totalArg = arr.length;
        ...
        switch (totalArg) {
            case 0:
                ...
                break;
            case 33:
                return new Type(arr[0], arr[1], arr[2], arr[3], arr[4], arr[5], arr[6], arr[7], arr[8],
            ...
            case 23:
                return new Type(arr[0], arr[1], arr[2], arr[3], arr[4], arr[5], arr[6], arr[7], arr[8],
                    arr[9], arr[10], arr[11], arr[12], arr[13], arr[14], arr[15], arr[16],
                    arr[17], arr[18], arr[19], arr[20], arr[21], arr[22]);
                break;
            case 22:
                return new Type(arr[0], arr[1], arr[2], arr[3], arr[4], arr[5], arr[6], arr[7], arr[8],
                    arr[9], arr[10], arr[11], arr[12], arr[13], arr[14], arr[15], arr[16],
            ...
            case 9:
                ...
                break;
            case 8:
                return new Type(arr[0], arr[1], arr[2], arr[3], arr[4], arr[5], arr[6], arr[7]);
                break;
            case 7:
                return new Type(arr[0], arr[1], arr[2], arr[3], arr[4], arr[5], arr[6]);
                break;
            case 6:
                return new Type(arr[0], arr[1], arr[2], arr[3], arr[4], arr[5]);
                break;
            case 5:
                return new Type(arr[0], arr[1], arr[2], arr[3], arr[4]);
                break;
            case 4:
                return new Type(arr[0], arr[1], arr[2], arr[3]);
                break;
            case 3:
                return new Type(arr[0], arr[1], arr[2]);
                break;
            case 2:
                return new Type(arr[0], arr[1]);
                break;
            case 1:
                return new Type(arr[0]);
                break;
            default:
                return new Type();
        }
